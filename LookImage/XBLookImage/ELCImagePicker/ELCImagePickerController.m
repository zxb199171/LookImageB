...
- (BOOL)shouldSelectAsset:(ELCAsset *)asset previousCount:(NSUInteger)previousCount
{
    ...
    if (!shouldSelect) {
        NSString *title = [NSString stringWithFormat:NSLocalizedString(@"总共只能上传这么多张", nil)];
        NSString *message = [NSString stringWithFormat:NSLocalizedString(@"提示", nil), self.maximumImagesCount];
